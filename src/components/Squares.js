...
export default function Squares() {
  ...
  // setting the state of square and active square
  ...
  const getClassName = id => {
    ...
    // if active square equals id passed through return and active square
    if (aSquare === id){
      return 'active'
    } else {
      return ''
      ...
      <div className='squares'>
        {
          ...
          // we changed this to square so that we can manipulate state in the future
